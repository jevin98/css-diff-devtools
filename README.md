...
<video src="./img/css-diff-demo.mp4" controls muted loop playsinline preload="metadata" width="100%" aria-label="CSS-Diff DevTools workflow demo">
  <a href="./img/css-diff-demo.mp4">Watch the CSS-Diff workflow video</a>
</video>
